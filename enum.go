 ...
 * @FilePath: \go-pbmo\enum.go
 * @Description: 枚举映射器 - 支持 int32 和泛型枚举类型映射
 *
...
func (em *EnumMapper) MapEnum(sourceEnum interface{}, targetEnumType reflect.Type, defaultValue interface{}) (interface{}, error) {
	...
	default:
		return defaultValue, fmt.Errorf("不支持的源枚举类型: %v", sourceVal.Kind())
	}
